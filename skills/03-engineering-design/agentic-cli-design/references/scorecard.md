...
| Principle                   | Score          | Max    |
| --------------------------- | -------------- | ------ |
| P1. Machine-readable        | **\_**         | 8      |
| P2. Non-interactive         | **\_**         | 6      |
| P3. Idempotent & Replayable | **\_**         | 6      |
| P4. Safe-by-default         | **\_**         | 4      |
| P5. Observable & Debuggable | **\_**         | 8      |
| P6. Context-efficient       | **\_**         | 6      |
| P7. Introspectable          | **\_**         | 6      |
| **TOTAL**                   | \***\*\_\*\*** | **44** |
...
| ------------------------ | ------ | ------------ | ----- |
| `--output json` exists   | ⬜     | \_\_\_/2     |       |
| stdout/stderr separation | ⬜     | \_\_\_/2     |       |
| Structured errors        | ⬜     | \_\_\_/2     |       |
| `schemaVersion` + docs   | ⬜     | \_\_\_/2     |       |
| **Subtotal**             |        | **\_\_\_/8** |       |
...
| Item                                 | Status | Points       | Notes |
| ------------------------------------ | ------ | ------------ | ----- |
| `--non-interactive` or TTY detection | ⬜     | \_\_\_/2     |       |
| Prompts are opt-in                   | ⬜     | \_\_\_/2     |       |
| Consistent `--yes`/`--force`         | ⬜     | \_\_\_/2     |       |
| **Subtotal**                         |        | **\_\_\_/6** |       |
...
| Item                   | Status | Points       | Notes |
| ---------------------- | ------ | ------------ | ----- |
| `--dedupe-key` support | ⬜     | \_\_\_/2     |       |
| `--if-exists` policy   | ⬜     | \_\_\_/2     |       |
| Pagination support     | ⬜     | \_\_\_/2     |       |
| **Subtotal**           |        | **\_\_\_/6** |       |
...
| Item                           | Status | Points       | Notes |
| ------------------------------ | ------ | ------------ | ----- |
| `--dry-run` support            | ⬜     | \_\_\_/2     |       |
| `--confirm`/`--force` required | ⬜     | \_\_\_/2     |       |
| **Subtotal**                   |        | **\_\_\_/4** |       |
...
| ---------------------- | ------ | ------------ | ----- |
| `--debug` flag         | ⬜     | \_\_\_/2     |       |
| `--log-format json`    | ⬜     | \_\_\_/2     |       |
| `--trace-id` support   | ⬜     | \_\_\_/2     |       |
| Categorized exit codes | ⬜     | \_\_\_/2     |       |
| **Subtotal**           |        | **\_\_\_/8** |       |
...
| Item                  | Status | Points       | Notes |
| --------------------- | ------ | ------------ | ----- |
| `--fields`/`--select` | ⬜     | \_\_\_/2     |       |
| `--output ndjson`     | ⬜     | \_\_\_/2     |       |
| Heavy fields opt-in   | ⬜     | \_\_\_/2     |       |
| **Subtotal**          |        | **\_\_\_/6** |       |
...
| Item              | Status | Points       | Notes |
| ----------------- | ------ | ------------ | ----- |
| `commands --json` | ⬜     | \_\_\_/2     |       |
| `schema` export   | ⬜     | \_\_\_/2     |       |
| `install-skills`  | ⬜     | \_\_\_/2     |       |
| **Subtotal**      |        | **\_\_\_/6** |       |
