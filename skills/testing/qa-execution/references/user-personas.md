...
A persona is the answer to _"who am I being right now while I test this?"_ A real-user QA session without a persona drifts into developer mindset — testing what the system can do instead of what a user would actually try.
...
When in doubt, ask: _"who is most likely to be hurt by this surface failing?"_ — that's the mandatory persona.
...
- Testlio — _Exploratory Testing 101: Step 3 — Adopt User Personas and Pair Testing_. The "new user / power user / casual user" tri-persona model originates in this guide.
- Thoughtworks — _10 tips for an Agile QA mindset, Tip 7 (Cross-Functional Requirements)_: persona-aware testing surfaces UX/usability/accessibility/compatibility CFRs that scripted tests miss.
- Sahipro — _Exploratory Testing Best Practices_: persona adoption as Step 3 of structured exploratory testing.
