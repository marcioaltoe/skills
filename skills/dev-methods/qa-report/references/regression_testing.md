...
Aligns with the verification report generated by `qa-execution`. When both skills are used, the verification report includes JOURNEY EXECUTION LOG and TEST CASE COVERAGE sections that cross-reference J-_ and TC-_ IDs from this regression suite.
...
- TestCollab — _Software Testing Strategies for QA Teams in 2026_: regression-as-protection framing.
- Thoughtworks — _10 tips for an Agile QA mindset, Tip 5_: automate routine regressions; keep exploratory manual.
