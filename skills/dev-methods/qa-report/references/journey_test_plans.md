...
- How many TC-PERSONA-_ / TC-JOURNEY-_ cover it
...
- **New User** (primary on this change) — 4 TC-PERSONA-_ + 2 TC-JOURNEY-_
- **Mobile User** (primary on this change) — 5 TC-PERSONA-_ + 3 TC-JOURNEY-_
...
- **Accessibility-Reliant** — 1 TC-PERSONA-_ + 1 TC-CFR-_ (a11y category)
...
- **Feature-named journeys** — _"Settings page test"_ is a feature test mislabeled. Rename to the value: _"Update notification preferences and confirm they arrive"_.
...
- Martin Fowler — _The Practical Test Pyramid_: high-value user journeys as the unit of E2E coverage.
- Incredibuild — _A Comprehensive Guide to E2E Testing_: journey-driven E2E catches cross-feature regressions.
- TestCollab — _Software Testing Strategies for QA Teams in 2026_: black-box behavioral testing maps to journeys.
