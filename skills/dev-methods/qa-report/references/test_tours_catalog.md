...
- Bullets in the canonical catalog are **prompts**, not a checklist. The mission is _to find bugs in the theme_, not to execute every bullet.
...
- James Whittaker — _Exploratory Software Testing_: original "tour" framing modernized in the canonical catalog.
