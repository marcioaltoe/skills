...
3. **Perceived performance** — what the user _feels_, not what synthetic tools report.
...
- Thoughtworks — _10 tips for an Agile QA mindset, Tip 7_: CFR as a first-class QA concern.
- Nielsen Norman Group — _10 Usability Heuristics_.
- W3C — _WCAG 2.1 Quick Reference_.
