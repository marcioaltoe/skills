...
_These prevent ship. Fix is non-negotiable._
...
_High-impact issues that should be fixed before ship if budget allows._
...
_Low-impact issues worth noting for the cleanup pass._
