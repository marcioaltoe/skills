...
1. **Visual Theme & Atmosphere** — brand personality, target audience, emotional tone (the _why_ before tokens)
...
The product brief (2–3 sentences) before tokens is what makes the rest legible — it anchors _why_ the tokens encode what they do.
...
export const Dialog = props => <RadixDialog.Root {...props} />;

export const DialogContent = props => <RadixDialog.Content className="..." {...props} />;
```
