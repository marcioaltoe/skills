...
IBM frames AI UX as designing the _relationship_ between user and system. Four pillars:
...
The system can explain _why_ — the inputs, the reasoning, the sources.
