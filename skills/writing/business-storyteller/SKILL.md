...
description: Transform technical work — features, products, fixes, refactors, architecture decisions, and how the software works — into rich, persuasive business-language documents that any non-technical audience (management, sales, marketing, HR, finance, accounting, compliance) can understand and approve. Produces internal announcements, approval proposals, incident explainers, technical-debt cases, product explainers, and investor/strategic-partner product memos as Markdown, styled HTML, or PDF, with SVG charts generated from source data. Use when the user says "present this feature to the company", "explain this to non-technical people", "write a business case for this refactor", "make an approval document", "explain how the software works to the business team", "present the product to investors or strategic partners", or asks for internal communication about technical work in business language (any language, including Portuguese). Do NOT use for technical documentation (READMEs, specs, ADRs), external marketing landing pages, or customer-facing sales copy.
metadata:
  category: writing
