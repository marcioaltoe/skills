...
- **Evidence.** _"Anti-Pattern: Using highly brittle selectors that are subject to change… Best Practice: Use `data-_` attributes."\* (https://docs.cypress.io/app/core-concepts/best-practices)
