...
**Tier 2 (Important)**: 4. "[Question to dig deeper]" 5. "[Question to validate]"

**Tier 3 (Nice-to-Have)**: 6. "[Additional context question]" 7. "[Competitive intelligence question]"
...
MEDDIC_Metrics_Score**c (Number, 0-10)
MEDDIC_Metrics_Evidence**c (Long Text)
MEDDIC_Economic_Buyer_Score**c (Number, 0-10)
MEDDIC_Economic_Buyer_Evidence**c (Long Text)
...
MEDDIC_Overall_Score**c (Formula: SUM of all scores)
MEDDIC_Status**c (Formula: IF >80, "Qualified", IF >50, "Risky", "Disqualified")
